...
public class Kasir extends javax.swing.JFrame {
    ...
    public Kasir() {
        ...
        String nomorFakturBaru = db.noFak();
    ...
    private void simpanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanButtonActionPerformed
        ...
        for (int i = 0; i < rowCount; i++) {
            ...
            Barang barang = db.getBarangByKodeBarang(kodeBarang);
            if (barang != null && barang.getStok() >= qty) {
                db.updateStokBarang(kodeBarang, qty);
                db.insertBarangTerjual(noFaktur, kodeBarang, namaBarang, harga, qty, total);
            } else {
        ...
        db.simpanPelanggan(noFaktur, subTotal, diskon, jumlahDiskon, grandTotal, bayar, kembalian);
    ...
    private void inputButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inputButtonActionPerformed
        ...
        // Cek stok barang
        int stok = db.getStokBarang(kodeBarang);
        if (qty > stok) {
    ...
    private void buatNotaPDF() {
        ...
        String filePath = "C:\\Users\\Adit\\OneDrive\\Documents\\Kuliah\\Semester 4\\PBO\\UAS\\" + fileName;
