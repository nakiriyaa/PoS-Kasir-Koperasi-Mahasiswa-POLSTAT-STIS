...
public class InputBarang extends javax.swing.JFrame {
    ...
    private void simpanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanButtonActionPerformed
        ...
        String kodeBarang = db.noKodeBarang(); // Mengambil kode barang baru dari database
        ...
        barang.setKodeBarang(kodeBarang); // Set kode barang yang dihasilkan
        barang.setNamaBarang(namaBarang);
        barang.setStok(stok);
        barang.setHarga(harga);

        // Panggil method insertBarang dari objek Database (db)
        ...
        namaBarangTextField.grabFocus(); // Fokus kembali ke field namaBarang
    ...
    private void hapusButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusButtonActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            db.deleteBarang(selectedKodeBarang);
    ...
    model.setRowCount(0); // Bersihkan semua baris yang ada
    ...
    model.fireTableDataChanged(); // Memastikan tabel merespons perubahan
}
